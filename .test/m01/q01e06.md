Help me please with the next project: **Harl filter**

- Files to turn in: `Makefile`, `main.cpp`, `Harl.hpp`, `Harl.cpp`
- Forbidden functions: `None`

Sometimes you don't want to pay attention to everyting Harl says. Implement a system to filter what Harl says depending on the log levels you want to listen to.
