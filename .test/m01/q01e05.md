Help me please with the next project: **Harl 2.0**

- Files to turn in: `Makefile`, `main.cpp`, `Harl.hpp`, `Harl.cpp`
...
- **"WARNING"** level: Warning messages indicate a potential issue in the system. Howver, it can be handled or ignored.  \
...
- **"ERROR"** level: These messages indicate that an unrecoverable error has occured. This is usually a critical issue that requires manual intervention.  \
