*  Can you help me with the subsequent "Towards a more useful fixed-point number class" project at 42 School?
...
- A constructor that takes a **constant integer** as a parameter.  \
  ...
  The fractional bits value should be initialized to 8, like in the previous exercise.
- A constructor that takes a **constant floating-point number** as a parameter.  \
  It converts it to the correspoinding fixed-point value.  \
